...
// components
import SEO from "components/SEOs/SEO";
...
export default function Navbar(props) {
  ...
  return (
    <>
    <SEO />
      <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-shaded shadow">
          ...
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a
                ...
                href="#TEP"
              >
              <img alt="..." className="w-best mr-1" src="/img/TEP.svg" />
              </a>
            </Link>
            <button
